...
public class FXMLTools {
    public static void loadContentIntoPane(String fxmlName, Pane pane) throws IOException {
        String resourcePath =  "/" +  fxmlName;
        System.out.println("Loading FXML: " + resourcePath);
        FXMLLoader loader =new FXMLLoader(FXMLTools.class.getResource(resourcePath));
